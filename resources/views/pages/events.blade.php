    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="{{ asset('assets/events.html') }}" class="active">Events</a></li>
          ...
          <div class="col-lg-8">
            <div class="events-list">
              <div class="event-item" data-aos="fade-up">
                ...
                <div class="event-content">
                  ...
                  <a href="{{ asset('assets/#') }}" class="btn-event">Learn More <i class="bi bi-arrow-right"></i></a>
                </div>
              </div><!-- End Event Item -->
            ...
            <div class="pagination-wrapper" data-aos="fade-up" data-aos-delay="400">
              <ul class="pagination justify-content-center">
                <li class="page-item disabled"><a class="page-link" href="{{ asset('assets/#') }}" tabindex="-1"><i class="bi bi-chevron-left"></i></a></li>
                <li class="page-item active"><a class="page-link" href="{{ asset('assets/#') }}">1</a></li>
                <li class="page-item"><a class="page-link" href="{{ asset('assets/#') }}">2</a></li>
                <li class="page-item"><a class="page-link" href="{{ asset('assets/#') }}">3</a></li>
                <li class="page-item"><a class="page-link" href="{{ asset('assets/#') }}"><i class="bi bi-chevron-right"></i></a></li>
              </ul>
            </div>
          </div>
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item featured-event" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="featured-event-content">
                  <img src="{{ asset('assets/assets/img/education/events-5.webp') }}" alt="Featured Event" class="img-fluid">
                  ...
                  <a href="{{ asset('assets/#') }}" class="btn-register">Register Now</a>
                </div>
              </div>
              ...
              <div class="sidebar-item" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="categories">
                  <ul>
                    <li><a href="{{ asset('assets/#') }}">Academic <span>(12)</span></a></li>
                    <li><a href="{{ asset('assets/#') }}">Sports <span>(8)</span></a></li>
                    <li><a href="{{ asset('assets/#') }}">Cultural <span>(6)</span></a></li>
                    <li><a href="{{ asset('assets/#') }}">Workshops <span>(4)</span></a></li>
                    <li><a href="{{ asset('assets/#') }}">Conferences <span>(3)</span></a></li>
                  </ul>
                </div>
              </div>
            </div>

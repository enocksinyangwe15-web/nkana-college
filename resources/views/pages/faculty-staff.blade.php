        ...
        <ul>
          ...
          <li class="dropdown"><a href="{{ asset('assets/about.html') }}"><span>About</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="{{ asset('assets/faculty-staff.html') }}" class="active">Faculty &amp; Staff</a></li>
              ...
              <div class="tab-pane fade show active" id="faculty--staff-tab-1">
                ...
                <div class="row g-4">
                  <div class="col-md-6 col-lg-4">
                    <div class="faculty-card">
                      <div class="faculty-image">
                        <img src="{{ asset('assets/assets/img/person/person-m-3.webp') }}" class="img-fluid" alt="Faculty Member">
                      </div>
                      <div class="faculty-info">
                        ...
                        <div class="faculty-contact">
                          <a href="{{ asset('assets/mailto:jbaker@example.com') }}"><i class="bi bi-envelope"></i> Email</a>
                          <a href="{{ asset('assets/#') }}" class="profile-link"><i class="bi bi-person"></i> Profile</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 col-lg-4">
                    <div class="faculty-card">
                      <div class="faculty-image">
                        <img src="{{ asset('assets/assets/img/person/person-f-5.webp') }}" class="img-fluid" alt="Faculty Member">
                      </div>
                      <div class="faculty-info">
                        ...
                        <div class="faculty-contact">
                          <a href="{{ asset('assets/mailto:swilson@example.com') }}"><i class="bi bi-envelope"></i> Email</a>
                          <a href="{{ asset('assets/#') }}" class="profile-link"><i class="bi bi-person"></i> Profile</a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 col-lg-4">
                    <div class="faculty-card">
                      <div class="faculty-image">
                        <img src="{{ asset('assets/assets/img/person/person-m-7.webp') }}" class="img-fluid" alt="Faculty Member">
                      </div>
                      <div class="faculty-info">
                        ...
                        <div class="faculty-contact">
                          <a href="{{ asset('assets/mailto:mchen@example.com') }}"><i class="bi bi-envelope"></i> Email</a>
                          <a href="{{ asset('assets/#') }}" class="profile-link"><i class="bi bi-person"></i> Profile</a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 col-lg-4">
                    <div class="faculty-card">
                      <div class="faculty-image">
                        <img src="{{ asset('assets/assets/img/person/person-f-9.webp') }}" class="img-fluid" alt="Faculty Member">
                      </div>
                      <div class="faculty-info">
                        ...
                        <div class="faculty-contact">
                          <a href="{{ asset('assets/mailto:erodriguez@example.com') }}"><i class="bi bi-envelope"></i> Email</a>
                          <a href="{{ asset('assets/#') }}" class="profile-link"><i class="bi bi-person"></i> Profile</a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 col-lg-4">
                    <div class="faculty-card">
                      <div class="faculty-image">
                        <img src="{{ asset('assets/assets/img/person/person-m-11.webp') }}" class="img-fluid" alt="Faculty Member">
                      </div>
                      <div class="faculty-info">
                        ...
                        <div class="faculty-contact">
                          <a href="{{ asset('assets/mailto:rwilliams@example.com') }}"><i class="bi bi-envelope"></i> Email</a>
                          <a href="{{ asset('assets/#') }}" class="profile-link"><i class="bi bi-person"></i> Profile</a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 col-lg-4">
                    <div class="faculty-card">
                      <div class="faculty-image">
                        <img src="{{ asset('assets/assets/img/person/person-f-2.webp') }}" class="img-fluid" alt="Faculty Member">
                      </div>
                      <div class="faculty-info">
                        <h4>Angela Davis</h4>
                        ...
                        <div class="faculty-contact">
                          <a href="{{ asset('assets/mailto:adavis@example.com') }}"><i class="bi bi-envelope"></i> Email</a>
                          <a href="{{ asset('assets/#') }}" class="profile-link"><i class="bi bi-person"></i> Profile</a>
                        </div>
                      </div>
                    </div>
              ...
              <div class="tab-pane fade" id="faculty--staff-tab-2">
                ...
                <div class="row g-4">
                  <div class="col-md-6 col-lg-4">
                    <div class="faculty-card">
                      <div class="faculty-image">
                        <img src="{{ asset('assets/assets/img/person/person-f-8.webp') }}" class="img-fluid" alt="Faculty Member">
                      </div>
                      <div class="faculty-info">
                        ...
                        <div class="faculty-contact">
                          <a href="{{ asset('assets/mailto:plee@example.com') }}"><i class="bi bi-envelope"></i> Email</a>
                          <a href="{{ asset('assets/#') }}" class="profile-link"><i class="bi bi-person"></i> Profile</a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 col-lg-4">
                    <div class="faculty-card">
                      <div class="faculty-image">
                        <img src="{{ asset('assets/assets/img/person/person-m-6.webp') }}" class="img-fluid" alt="Faculty Member">
                      </div>
                      <div class="faculty-info">
                        ...
                        <div class="faculty-contact">
                          <a href="{{ asset('assets/mailto:tgrant@example.com') }}"><i class="bi bi-envelope"></i> Email</a>
                          <a href="{{ asset('assets/#') }}" class="profile-link"><i class="bi bi-person"></i> Profile</a>
                        </div>
                      </div>
                    </div>
              ...
              <div class="tab-pane fade" id="faculty--staff-tab-3">
                ...
                <div class="row g-4">
                  <div class="col-md-6 col-lg-4">
                    <div class="faculty-card">
                      <div class="faculty-image">
                        <img src="{{ asset('assets/assets/img/person/person-m-9.webp') }}" class="img-fluid" alt="Faculty Member">
                      </div>
                      <div class="faculty-info">
                        ...
                        <div class="faculty-contact">
                          <a href="{{ asset('assets/mailto:narmstrong@example.com') }}"><i class="bi bi-envelope"></i> Email</a>
                          <a href="{{ asset('assets/#') }}" class="profile-link"><i class="bi bi-person"></i> Profile</a>
                        </div>
                      </div>
                    </div>
              ...
              <div class="tab-pane fade" id="faculty--staff-tab-4">
                ...
                <div class="row g-4">
                  <div class="col-md-6 col-lg-4">
                    <div class="faculty-card">
                      <div class="faculty-image">
                        <img src="{{ asset('assets/assets/img/person/person-f-12.webp') }}" class="img-fluid" alt="Faculty Member">
                      </div>
                      <div class="faculty-info">
                        <h4>Dr. Lisa Wong</h4>
                        <p class="faculty-title">Department Chair, Professor</p>
                        ...
                        <div class="faculty-contact">
                          <a href="{{ asset('assets/mailto:lwong@example.com') }}"><i class="bi bi-envelope"></i> Email</a>
                          <a href="{{ asset('assets/#') }}" class="profile-link"><i class="bi bi-person"></i> Profile</a>
                        </div>
                      </div>
                    </div>
              ...
              <div class="tab-pane fade" id="faculty--staff-tab-5">
                ...
                <div class="row g-4">
                  <div class="col-md-6 col-lg-4">
                    <div class="faculty-card">
                      <div class="faculty-image">
                        <img src="{{ asset('assets/assets/img/person/person-m-2.webp') }}" class="img-fluid" alt="Faculty Member">
                      </div>
                      <div class="faculty-info">
                        ...
                        <div class="faculty-contact">
                          <a href="{{ asset('assets/mailto:dsmith@example.com') }}"><i class="bi bi-envelope"></i> Email</a>
                          <a href="{{ asset('assets/#') }}" class="profile-link"><i class="bi bi-person"></i> Profile</a>
                        </div>
                      </div>
                    </div>

        ...
        <ul>
          ...
          <li class="dropdown"><a href="{{ asset('assets/about.html') }}"><span>About</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="{{ asset('assets/academics.html') }}" class="active">Academics</a></li>
          ...
          <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0" data-aos="fade-right" data-aos-delay="200">
              <div class="intro-image">
                <img src="{{ asset('assets/assets/img/education/education-1.webp') }}" alt="Academic Programs" class="img-fluid rounded-lg shadow">
              ...
              <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                <div class="program-item undergraduate">
                  ...
                  <div class="program-footer">
                    <a href="{{ asset('assets/#') }}" class="program-link">View Program <i class="bi bi-arrow-right"></i></a>
                  </div>
                </div>
              </div>
                ...
                <div class="row align-items-center">
                  <div class="col-lg-5 mb-4 mb-lg-0" data-aos="fade-right" data-aos-delay="100">
                    <div class="featured-program-image">
                      <img src="{{ asset('assets/assets/img/education/education-5.webp') }}" alt="Artificial Intelligence Program" class="img-fluid">
                  ...
                  <div class="col-lg-7" data-aos="fade-left" data-aos-delay="200">
                    <div class="featured-program-content">
                      ...
                      <div class="featured-program-action">
                        <a href="{{ asset('assets/#') }}" class="btn-apply">Apply Now</a>
                        <a href="{{ asset('assets/#') }}" class="btn-details">Program Details</a>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="row align-items-center">
            <div class="col-lg-5 mb-4 mb-lg-0" data-aos="fade-right" data-aos-delay="100">
              <div class="stats-content">
                ...
                <a href="{{ asset('assets/#') }}" class="btn-about">About Our Institution</a>
              </div>
            </div>
            <div class="col-lg-7" data-aos="fade-left" data-aos-delay="200">

        ...
        <ul>
          ...
          <li class="dropdown"><a href="{{ asset('assets/#') }}"><span>More Pages</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="{{ asset('assets/404.html') }}" class="active">Error 404</a></li>
            ...
            <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
              <div class="error-content">
                ...
                <div class="error-actions" data-aos="fade-up" data-aos-delay="800">
                  <a href="{{ asset('assets//') }}" class="btn-home">
                    <i class="bi bi-house-door"></i> Back to Home
                  </a>
                  <a href="{{ asset('assets/#') }}" class="btn-help">
                ...
                <div class="error-suggestions" data-aos="fade-up" data-aos-delay="900">
                  ...
                  <ul>
                    <li><a href="{{ asset('assets/#') }}"><i class="bi bi-arrow-right-circle"></i> Check our sitemap</a></li>
                    <li><a href="{{ asset('assets/#') }}"><i class="bi bi-arrow-right-circle"></i> Contact support</a></li>
                    <li><a href="{{ asset('assets/#') }}"><i class="bi bi-arrow-right-circle"></i> Return to previous page</a></li>
                  </ul>
                </div>
              </div>
            </div>

    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="{{ asset('assets/students-life.html') }}" class="active">Students Life</a></li>
    ...
    <section id="students-life" class="students-life section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="students-life-banner" data-aos="zoom-in" data-aos-delay="200">
          ...
          <img src="{{ asset('assets/assets/img/education/showcase-2.webp') }}" alt="Campus Life" class="img-fluid">
        </div>
              ...
              <div class="row g-4">
                <div class="col-lg-5" data-aos="fade-right" data-aos-delay="200">
                  <div class="tab-content-image">
                    <img src="{{ asset('assets/assets/img/education/students-2.webp') }}" alt="Student Clubs" class="img-fluid rounded">
                ...
                <div class="col-lg-7" data-aos="fade-left" data-aos-delay="300">
                  <div class="tab-content-text">
                    ...
                    <a href="{{ asset('assets/#') }}" class="btn btn-explore mt-4">Explore All Clubs <i class="bi bi-arrow-right"></i></a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="tab-pane fade" id="students-life-athletics" role="tabpanel" aria-labelledby="athletics-tab">
              <div class="row g-4 mb-4 align-items-center">
                <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
                  ...
                  <a href="{{ asset('assets/#') }}" class="btn btn-explore">View Athletics Calendar <i class="bi bi-arrow-right"></i></a>
                </div>
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="sport-card">
                      <img src="{{ asset('assets/assets/img/education/activities-2.webp') }}" class="img-fluid" loading="lazy" alt="Swimming">
                  ...
                  <div class="swiper-slide">
                    <div class="sport-card">
                      <img src="{{ asset('assets/assets/img/education/activities-4.webp') }}" class="img-fluid" loading="lazy" alt="Basketball">
                      <div class="sport-info">
                        <h5>Basketball</h5>
                        <div class="badge">Varsity</div>
                      </div>
                  ...
                  <div class="swiper-slide">
                    <div class="sport-card">
                      <img src="{{ asset('assets/assets/img/education/activities-6.webp') }}" class="img-fluid" loading="lazy" alt="Soccer">
                      <div class="sport-info">
                        <h5>Soccer</h5>
                        <div class="badge">Varsity</div>
                      </div>
                  ...
                  <div class="swiper-slide">
                    <div class="sport-card">
                      <img src="{{ asset('assets/assets/img/education/activities-8.webp') }}" class="img-fluid" loading="lazy" alt="Tennis">
                      <div class="sport-info">
                        <h5>Tennis</h5>
                        <div class="badge">Varsity</div>
                      </div>
                  ...
                  <div class="swiper-slide">
                    <div class="sport-card">
                      <img src="{{ asset('assets/assets/img/education/activities-10.webp') }}" class="img-fluid" loading="lazy" alt="Volleyball">
                      <div class="sport-info">
                        <h5>Volleyball</h5>
                        <div class="badge">Varsity</div>
                      </div>
              ...
              <div class="row g-4">
                <div class="col-lg-8" data-aos="fade-right" data-aos-delay="200">
                  <div class="facilities-gallery">
                    <div class="row g-3">
                      <div class="col-md-8">
                        <img src="{{ asset('assets/assets/img/education/campus-4.webp') }}" alt="Housing" class="img-fluid rounded">
                      </div>
                      <div class="col-md-4">
                        <img src="{{ asset('assets/assets/img/education/campus-5.webp') }}" alt="Dining" class="img-fluid rounded">
                      </div>
                      <div class="col-md-4">
                        <img src="{{ asset('assets/assets/img/education/campus-6.webp') }}" alt="Library" class="img-fluid rounded">
                      </div>
                      <div class="col-md-8">
                        <img src="{{ asset('assets/assets/img/education/campus-7.webp') }}" alt="Recreation" class="img-fluid rounded">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4" data-aos="fade-left" data-aos-delay="300">
                  <div class="facilities-info">
                    ...
                    <a href="{{ asset('assets/#') }}" class="btn btn-explore mt-3">Virtual Campus Tour <i class="bi bi-arrow-right"></i></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row g-4">
                <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
                  <div class="support-card">
                    ...
                    <a href="{{ asset('assets/#') }}" class="service-link">Learn More <i class="bi bi-arrow-right"></i></a>
                  </div>
                </div>
              ...
              <div class="row mt-5" data-aos="fade-up" data-aos-delay="500">
                <div class="col-md-6 offset-md-3 text-center">
                  <div class="contact-info-box">
                    ...
                    <a href="{{ asset('assets/#') }}" class="btn btn-explore mt-2">Contact Student Services <i class="bi bi-arrow-right"></i></a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="students-life-gallery mt-5" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="row g-3">
            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="100">
              <a href="{{ asset('assets/assets/img/education/students-1.webp') }}" class="gallery-item glightbox">
                <img src="{{ asset('assets/assets/img/education/students-1.webp') }}" class="img-fluid" loading="lazy" alt="Student Life">
            ...
            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="200">
              <a href="{{ asset('assets/assets/img/education/students-2.webp') }}" class="gallery-item glightbox">
                <img src="{{ asset('assets/assets/img/education/students-2.webp') }}" class="img-fluid" loading="lazy" alt="Student Life">
                <div class="gallery-overlay">
            ...
            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="300">
              <a href="{{ asset('assets/assets/img/education/students-3.webp') }}" class="gallery-item glightbox">
                <img src="{{ asset('assets/assets/img/education/students-3.webp') }}" class="img-fluid" loading="lazy" alt="Student Life">
                <div class="gallery-overlay">
            ...
            <div class="col-md-6" data-aos="zoom-in" data-aos-delay="400">
              <a href="{{ asset('assets/assets/img/education/students-4.webp') }}" class="gallery-item glightbox">
                <img src="{{ asset('assets/assets/img/education/students-4.webp') }}" class="img-fluid" loading="lazy" alt="Student Life">
                <div class="gallery-overlay">
            ...
            <div class="col-md-6" data-aos="zoom-in" data-aos-delay="500">
              <a href="{{ asset('assets/assets/img/education/students-5.webp') }}" class="gallery-item glightbox">
                <img src="{{ asset('assets/assets/img/education/students-5.webp') }}" class="img-fluid" loading="lazy" alt="Student Life">
                <div class="gallery-overlay">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg-4" data-aos="fade-left" data-aos-delay="400">
                <div class="cta-buttons">
                  <a href="{{ asset('assets/#') }}" class="btn btn-primary">Schedule a Visit</a>
                  <a href="{{ asset('assets/#') }}" class="btn btn-outline">Apply Now</a>
                </div>
              </div>
            </div>
          </div>

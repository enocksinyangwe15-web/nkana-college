      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="{{ asset('assets/#') }}"><span>More Pages</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="{{ asset('assets/news-details.html') }}" class="active">News Details</a></li>
        ...
        <article class="article">
          <div class="article-header">
            <div class="meta-categories" data-aos="fade-up">
              <a href="{{ asset('assets/#') }}" class="category">Technology</a>
              <a href="{{ asset('assets/#') }}" class="category">Innovation</a>
            </div>
            ...
            <div class="article-meta" data-aos="fade-up" data-aos-delay="200">
              <div class="author">
                <img src="{{ asset('assets/assets/img/person/person-m-6.webp') }}" alt="Author" class="author-img">
          ...
          <div class="article-featured-image" data-aos="zoom-in">
            <img src="{{ asset('assets/assets/img/blog/blog-hero-1.webp') }}" alt="UI Design Evolution" class="img-fluid">
          </div>
          ...
          <div class="article-wrapper">
            <aside class="table-of-contents" data-aos="fade-left">
              ...
              <nav>
                <ul>
                  <li><a href="{{ asset('assets/#introduction') }}" class="active">Introduction</a></li>
                  <li><a href="{{ asset('assets/#skeuomorphism') }}">The Skeuomorphic Era</a></li>
                  <li><a href="{{ asset('assets/#flat-design') }}">Flat Design Revolution</a></li>
                  <li><a href="{{ asset('assets/#material-design') }}">Material Design</a></li>
                  <li><a href="{{ asset('assets/#neumorphism') }}">Rise of Neumorphism</a></li>
                  <li><a href="{{ asset('assets/#future') }}">Future Trends</a></li>
                </ul>
              </nav>
            </aside>
            ...
            <div class="article-content">
              ...
              <div class="content-section" id="skeuomorphism" data-aos="fade-up">
                ...
                <div class="image-with-caption right">
                  <img src="{{ asset('assets/assets/img/blog/blog-hero-2.webp') }}" alt="Skeuomorphic Design Example" class="img-fluid" loading="lazy">
          ...
          <div class="article-footer" data-aos="fade-up">
            <div class="share-article">
              ...
              <div class="share-buttons">
                <a href="{{ asset('assets/#') }}" class="share-button twitter">
                  <i class="bi bi-twitter-x"></i>
                  <span>Share on X</span>
                </a>
                <a href="{{ asset('assets/#') }}" class="share-button facebook">
                  <i class="bi bi-facebook"></i>
                  <span>Share on Facebook</span>
                </a>
                <a href="{{ asset('assets/#') }}" class="share-button linkedin">
            ...
            <div class="article-tags">
              ...
              <div class="tags">
                <a href="{{ asset('assets/#') }}" class="tag">UI Design</a>
                <a href="{{ asset('assets/#') }}" class="tag">User Experience</a>
                <a href="{{ asset('assets/#') }}" class="tag">Design Trends</a>
                <a href="{{ asset('assets/#') }}" class="tag">Innovation</a>
                <a href="{{ asset('assets/#') }}" class="tag">Technology</a>
              </div>
            </div>
          </div>
